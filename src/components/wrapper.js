...
class Wrapper extends React.Component {
  render () {
    ...
    return (
      <Layout fixedDrawer>
        <Drawer>
          <UpdateButton messages={filteredAndSorted} onClick={this.props.update} />
          ...
          <MessageList selected={this.props.selected} messages={filteredAndSorted} select={this.props.selectMessage} />
        </Drawer>
        <SimpleMap messages={filteredAndSorted} selected={this.props.selected} selectMessage={this.props.selectMessage} />
      </Layout>
    )
  }
}
